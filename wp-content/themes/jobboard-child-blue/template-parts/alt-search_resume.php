<?php
/**
 * Template Part Name : Resume Search Form
 *
 * @package WordPress
...
<div class="row">
  <div class="col-md-6">
	...
	<div class="row">
	  ...
	  <div class="col-md-6">
		<div class="form-group">
		  <?php $typed_location = isset($_GET['resume_search_location']) ? $_GET['resume_search_location'] : ''; ?>
  ...
  <div class="col-md-6">
	...
	<div class="col-md-12">
		<div class="form-group text-right">
		  ...
		  ?>
		  <button type="submit" name="submit" class="btn btn-search-resume" value="1"><?php echo esc_attr( $button_text ); ?></button>
		</div><!-- /.form-group -->
	</div>
