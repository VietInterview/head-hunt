					...
					*/
					...
					<form id="register-form" action="<?php echo esc_url( get_permalink( get_the_id() ) ); ?>" method="post">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="radio radio-info form-radio-group">
									<input type="radio" name="register_role" id="register_role_job_seeker" value="job_seeker" checkeds />
									<label for="register_role_job_seeker"><?php _e( 'Job Seeker', 'jobboard' ); ?></label>
								</div><!-- /.form-radio-group-->
							</div><!-- /.col-sm-6 -->
						</div><!-- /.row -->
