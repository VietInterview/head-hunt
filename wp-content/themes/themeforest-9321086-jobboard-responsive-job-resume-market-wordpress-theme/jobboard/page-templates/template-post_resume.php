...
if (!current_user_can( 'manage_options' )) {
  ...
  //   if(jobboard_option('enable_package_resume') == '1' && $is_limit){
			...
			<div class="col-md-8">
				<form method="post" class="frontend-form" action="" id="post-resume" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select id="resume_category" name="category">
					...
					<div class="form-group">
						<label for="year_experience"><?php _e( 'Year Experience', 'jobboard' ); ?></label>
						...
						<span class="help-block"><?php _e( 'Number value only. Ex: 5', 'jobboard' ); ?></span>
					</div><!-- /.forn-group -->

					<div class="form-group">
						<label for="proposed_monthly_sallary"><?php printf( __( 'Proposed monthly salary (%s)', 'jobboard' ), jobboard_option( 'currency_sign' ) ); ?></label>
						...
						<span class="help-block"><?php _e( 'Do not include currency sign. Ex: 300', 'jobboard' ); ?></span>
					</div><!-- /.forn-group -->
					...
					<div class="form-group">
						...
						<?php
							if( isset($_GET['action']) && $_GET['action'] == 'edit' ){
                                ...
                                if(!empty($file)){
						?>
									<div class="alert alert-success resume-file">
                                      <input type="hidden" name="resume_file_status" id="resume_file_status" value="" />
                                      ...
                                      <a href="<?php echo $file; ?>" title="<?php _e( 'View Resume File', 'jobboard' ); ?>" target="_blank">
