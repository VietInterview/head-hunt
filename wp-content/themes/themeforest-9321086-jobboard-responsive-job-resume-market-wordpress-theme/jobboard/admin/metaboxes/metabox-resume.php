...
return array(
	...
	array(
		...
		'label'	=> __( 'Year Experience', 'jobboard' ),
		'description'	=> __( 'ex: "5"', 'jobboard' ),
	),
	array(
		'type'	=> 'textbox',
		'name'	=> 'proposed_monthly_sallary',
		'label'	=> sprintf( __( 'Proposed monthly salary (%s)', 'jobboard' ), jobboard_option( 'currency_sign' ) ),
		'description'	=> __( 'Do not include currency sign. Ex: 300', 'jobboard' ),
	),
	array(
		'type'		=> 'group',
		'repeating'	=> false,
