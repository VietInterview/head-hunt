...
<div id="post-<?php echo get_the_id(); ?>" class="row">
	<div class="col-sm-3 blog-list-author hidden-xs">
		...
		<div class="blog-list-author-name">
			<?php echo __( 'By', 'jobboard' ).'&nbsp;'. esc_attr( get_the_author_meta( 'display_name' ) ); ; ?>
	...
	<div class="col-sm-9 blog-detail-content">
		<article id="blog-<?php echo get_the_id(); ?>" <?php post_class(); ?> >
			...
			<?php
				...
				the_content();
				wp_link_pages( array( 'before' => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'jobboard' ) . '</span>', 'after' => '</div>', 'link_before' => '<span>', 'link_after' => '</span>' ) ); 
			?>
