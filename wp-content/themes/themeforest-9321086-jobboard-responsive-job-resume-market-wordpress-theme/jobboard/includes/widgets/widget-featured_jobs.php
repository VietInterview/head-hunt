 ...
 */
if ( !class_exists( 'Jobboard_Featured_Job' ) ) :
				...
				<div class="featured-job-type clearfix">
						<div class="featured-job-location">
							...
							<?php
								...
								if($job_taxs){
									foreach( $job_taxs as $key => $job_tax ){
										echo '<span class="job_region-' . $key . '">' . esc_attr( $job_tax->name ) . '</span> ';
									}
								}
							?>
						...
						<div class="featured-job-contract">
							...
							<?php
								...
								if($job_taxs){
									foreach( $job_taxs as $key => $job_tax ){
										echo '<span class="job_type-' . $key . '">' . esc_attr( $job_tax->name ) . '</span> ';
									}
								}
							?>
