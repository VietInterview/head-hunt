...
<div id="jobs-listing" class="related-job-listing featured-job">
  <div class="container">
    ...
    <div id="all_resumes">
      ...
      // Resume Category
      if( isset($_GET['resume_search_category']) && $_GET['resume_search_category'] != '' ) :

        $resume_category = $_GET['resume_search_category'];
      ...
      // Career Level
      if( isset($_GET['resume_search_career_level']) && $_GET['resume_search_career_level'] != '' ) :

        $career_level = $_GET['resume_search_career_level'];
      ...
      if( isset($_GET['resume_search_experience']) && $_GET['resume_search_experience'] != '' ) {
        ...
        */
        ...
        $resume_search_experience = array(
          'key' => '_resume_experience',
          'value' => array(0,$_GET['resume_search_experience']),
		  'type' => 'NUMERIC',
          'compare' => 'BETWEEN'
        );
