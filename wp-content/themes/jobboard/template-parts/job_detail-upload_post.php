				...
				<div class="upload-post-job-wrapper resume">
					...
					<?php
						...
						if( jobboard_option('post_1_button_icon') ){
							echo htmlspecialchars_decode( '<i class="fa '.jobboard_option('post_1_button_icon').'"></i>') ;
						}//endif;
					?>
					</a>
				...
				<div class="upload-post-job-wrapper job">
					...
					<?php
						...
						if( jobboard_option('post_2_button_icon') ){
							echo htmlspecialchars_decode( '<i class="fa '.esc_attr( jobboard_option('post_2_button_icon') ).'"></i>' );
						}//endif;
					?>
					</a>
				</div><!-- /.upload-post-job-wrapper -->
