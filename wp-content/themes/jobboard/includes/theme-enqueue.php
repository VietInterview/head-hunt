...
function jobboard_enqueue_scripts(){
    ...
    // Load Retina.js
	wp_enqueue_script( 'retina-js', get_template_directory_uri().'/assets/js/retina.min.js', array(), '1.3.0', true );
	...
	// Load Flexslider
	wp_enqueue_script( 'flexslider', get_template_directory_uri().'/assets/js/jquery.flexslider-min.js', array('jquery'), '2.5.0', true );
	wp_enqueue_style( 'flexslider', get_template_directory_uri().'/assets/css/flexslider.css', array(), '0.0.1', 'screen' );
	...
	wp_enqueue_script( 'selectize-js', get_template_directory_uri().'/assets/js/jquery.selectize.min.js', array( 'jquery' ), '0.12.1', true  );
	wp_enqueue_style( 'selectize-css', get_template_directory_uri().'/assets/css/jquery.selectize.css', '0.12.1', 'all' );
	...
	if( is_page_template( 'page-templates/template-homepage-2.php' ) || is_page_template( 'page-templates/template-homepage.php' ) || is_page_template( 'page-templates/template-job_listing.php' ) || is_page_template( 'page-templates/template-job_search.php' ) ){
		$slider_init = true;
		...
		$slider_settings = array(
			...
			'flexslider_animation'	=> jobboard_option( 'flexslider_animation' ),
			'flexslider_auto_slide'	=> jobboard_option( 'flexslider_auto_slide' ),
			'flexslider_delay'		=> jobboard_option( 'flexslider_delay' ),
		);
