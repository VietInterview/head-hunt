 ...
 */
if ( !class_exists( 'Jobboard_Custom_Button' ) ) :
Class Jobboard_Custom_Button extends WP_Widget{
	...
	?>
		<div class="upload-post-job-wrapper resume">
			...
			<a href="<?php echo esc_url( $instance['button_url'] ); ?>" class="btn btn-custom-button-widget"><?php echo htmlspecialchars_decode( esc_html( $instance['btn_text'] ) ); ?></a>
