...
if( !function_exists( 'jobboard_get_search_resume_page' ) ){

	function jobboard_get_search_resume_page(){
		$page_list = array();
		$pages = get_posts( array(
			'post_type'		=> 'page',
			'meta_query'	=> array(
				array(
					'key'	=> '_wp_page_template',
					'value'	=> 'page-templates/template-resume_listing.php',
				),
			),
		) );
	...
	VP_Security::instance()->whitelist_function('jobboard_get_search_resume_page');
...
if( !function_exists( 'jobboard_get_type_job' ) ){

	function jobboard_get_type_job(){
	...
	VP_Security::instance()->whitelist_function('jobboard_get_type_job');
}//endif;
